...
# 连接串从项目统一配置取(resolved_db_url:未设 DATABASE_URL 回退 SQLite),
# 而非 alembic.ini 硬编码——本地/生产靠 env 一处切换。
...
# M10 模型 metadata,供 autogenerate 比对。
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        render_as_batch=url.startswith("sqlite"),   # SQLite 无原生 ALTER,批处理模式兜底
    )
