...
category:
  - 云原生
---
![](/blog/assets/posts/k8s%E7%9A%84%E6%9E%B6%E6%9E%84-1.svg)

**参考官方文档：**[https://kubernetes.io/zh-cn/docs/concepts/overview/components/](https://kubernetes.io/zh-cn/docs/concepts/overview/components/)
...
控制平面组件会为集群做出全局决策，比如资源的调度。 以及检测和响应集群事件，例如当不满足 Deployment 的 `[replicas](https://kubernetes.io/zh-cn/docs/reference/glossary/?all=true#term-replica)` 字段时，要启动新的 [Pod](https://kubernetes.io/zh-cn/docs/concepts/workloads/pods/)）。
