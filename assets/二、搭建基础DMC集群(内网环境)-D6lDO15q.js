...
<span class="line"><span># 一键配置 SNAT/DNAT 脚本（补充关键项，不修改原有规则逻辑）</span></span>
<span class="line"><span></span></span>
<span class="line"><span># 0. 检查是否为 root 用户（非 root 无权限操作 iptables）</span></span>
<span class="line"><span>if [ $UID -ne 0 ]; then</span></span>
<span class="line"><span>    echo "错误：请使用 root 用户执行此脚本！"</span></span>
<span class="line"><span>    exit 1</span></span>
<span class="line"><span>fi</span></span>
<span class="line"><span></span></span>
<span class="line"><span># 1. 开启路由转发</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span># 2. 清空规则</span></span>
<span class="line"><span>iptables -F</span></span>
<span class="line"><span>iptables -t nat -F</span></span>
<span class="line"><span></span></span>
<span class="line"><span># 3. 配置 SNAT（内网流量伪装成外网 IP 访问外网）</span></span>
<span class="line"><span>iptables -t nat -A POSTROUTING -s 192.168.31.0/24 -o ens160   -j MASQUERADE</span></span>
<span class="line"><span>iptables -t nat -A POSTROUTING -s 192.168.31.0/24 -o ens224   -j MASQUERADE</span></span>
<span class="line"><span></span></span>
<span class="line"><span># 4. 配置 DNAT（端口转发，发布两个 VIP 提供 Web 服务）</span></span>
<span class="line"><span>iptables -t nat -A PREROUTING -d 192.168.1.8 -i ens160 -p tcp --dport 80 -j DNAT --to-destination 192.168.31.130</span></span>
<span class="line"><span>iptables -t nat -A PREROUTING -d 192.168.1.8 -i ens160 -p tcp --dport 80 -j DNAT --to-destination 192.168.31.131</span></span>
<span class="line"><span></span></span>
<span class="line"><span># 5. 配置堡垒机端口转发（2233 → 堡垒机 22 端口）</span></span>
<span class="line"><span>iptables -t nat -A PREROUTING -d 192.168.1.8 -i ens160 -p tcp --dport 2233 -j DNAT --to-destination 192.168.31.136:22</span></span>
<span class="line"><span></span></span>
<span class="line"><span># 6. 保存 iptables 规则（重启后生效，适配 CentOS/Ubuntu 主流系统）</span></span>
...
<span class="line"><span>    echo "规则已保存，重启后生效！"</span></span>
<span class="line"><span>else</span></span>
<span class="line"><span>    echo "提示：未找到 iptables-save 命令，需手动保存规则"</span></span>
<span class="line"><span>fi</span></span>
<span class="line"><span></span></span>
<span class="line"><span>echo "SNAT/DNAT 规则配置完成！"</span></span></code></pre>
